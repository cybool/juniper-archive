...
def core(module):
    ...
    if response.status_code != 200:
        module.fail_json(
            msg=f"Failed to receive information about the current sites, here is the response information to help you debug : {response.info}"
        )
    ...
    # ### ########################################################################
        ...
        if site["provisioned"] is False:
            ...
            site_data = dict(
                ...
                gatewaytemplate_id=module.params["gatewaytemplate_id"],
...
def main():
    ...
    # ### ########################################################################
    argument_spec = MistHelper.site_spec()

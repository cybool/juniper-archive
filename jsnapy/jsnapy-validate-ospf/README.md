# Ansible Automation Example: JSNAPY OSPF Validation
...
This example will show how to validate the status of our OSPF neighbors with JSNAPY over NETCONF RPCs.
